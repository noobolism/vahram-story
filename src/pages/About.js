      ...
      <div className="max-w-4xl mx-auto mt-16">
        <div className="bg-gray-800 bg-opacity-75 rounded-lg p-8 md:p-16">
          ...
          <p className="text-xl mb-4">
            بهترین چیزی که میتونستم بعنوان اسم این داستان بگم همینه:
          </p>
          ...
          <p className="text-lg mb-6">
               ...
               به قلم آریا نامداری -  برنامه‌نویس و نویسنده علاقه‌مند به داستان‌های علمی تخیلی "دانشجوی دانشگاه علم و فرهنگ"
          </p>
